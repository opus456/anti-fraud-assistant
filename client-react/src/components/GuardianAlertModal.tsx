...
export default function GuardianAlertModal({ onClose }: GuardianAlertModalProps) {
  ...
  const getRiskLabel = (level: number) => {
    switch (level) {
      case 3: return { text: '极高风险', color: 'text-red-700 bg-rose-50' };
      case 2: return { text: '高风险', color: 'text-rose-600 bg-rose-50' };
      case 1: return { text: '中风险', color: 'text-amber-600 bg-amber-100' };
      default: return { text: '低风险', color: 'text-emerald-600 bg-emerald-50' };
    }
  };
