...
/** 移动端底部 5 个标签 */
const mobileTabIndices = [0, 1, 2, 6, 9]; // 控制台, 实时监控, 智能检测, 预警中心, 我的画像
      ...
      >
        ...
        <nav className="flex-1 py-4 overflow-y-auto space-y-0.5">
          ...
          {visibleRoleItems.length > 0 && (
            <>
              <div className="mx-6 my-3 border-t border-primary-700" />
              <p className="px-6 text-xs text-gray-500 uppercase tracking-wider mb-1">
                管理功能
              </p>
